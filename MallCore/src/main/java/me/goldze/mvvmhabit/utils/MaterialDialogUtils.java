...
public class MaterialDialogUtils {
    ...
    public static MaterialDialog.Builder showIndeterminateProgressDialog(Context context, String content, boolean horizontal) {
        @SuppressLint("ResourceType") MaterialDialog.Builder builder = new MaterialDialog.Builder(context)
                .title(content)
                .backgroundColor(Color.parseColor("#1B202E"))
                .titleColor(Color.parseColor("#707B8E"))
                .progress(true, 0)
