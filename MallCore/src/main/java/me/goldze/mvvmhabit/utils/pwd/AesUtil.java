...
public class AesUtil {
    private static final String KEY = "1234ABCD1234ABCD";
    //"算法/模式/补码方式"
    ...
    public static String enCode(String content) {
        try {
            ...
            return Base64.encodeToString(encode_content,Base64.DEFAULT); //将加密后的数据转换为字符串返回
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }  
    ...
    public static String deCode(String content) {
        try {
            ...
            byte [] encode_content = Base64.decode(content,Base64.DEFAULT); //把密文字符串转回密文字节数组
