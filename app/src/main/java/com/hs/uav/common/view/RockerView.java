...
public class RockerView extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:// 移动
                ...
                KLog.e(TAG, "移动数据：X = " + mRockerPosition.x + " Y = " + mRockerPosition.y);
                if (mOnAngleChangeListener != null) {
                    mOnAngleChangeListener.callBackXY(mCenterPoint.x, mCenterPoint.y, mRockerPosition.x, mRockerPosition.y);
                }
                break;
    ...
    public interface OnAngleChangeListener {
         ...
         * @param y
         */
        void callBackXY(int pointX, int pointY, int x, int y);
