package com.hs.uav.common.view.scaleruler;
...
public class ScaleRulerView extends View {
    ...
    private static final int ITEM_MAX_HEIGHT = 100;  //最大刻度高度
    private static final int ITEM_MIN_HEIGHT = 10;  //最小刻度高度
